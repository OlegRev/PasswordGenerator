...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(":/icons/icons/app-icon.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/icons/icons/lock_white_24dp.svg", QSize(), QIcon.Disabled, QIcon.On
        )
        ...
        sizePolicy.setHeightForWidth(
            self.frame_password.sizePolicy().hasHeightForWidth()
        )
        self.frame_password.setSizePolicy(sizePolicy)
        self.frame_password.setStyleSheet(
            "QFrame {\n"
            "    border: 2px solid gray;\n"
            "    border-radius: 5px;\n"
            "    margin-right: 0;\n"
        ...
        icon2 = QIcon()
        icon2.addFile(
            ":/icons/icons/visibility_off_white_24dp.svg",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        icon2.addFile(
            ":/icons/icons/visibility_white_24dp.svg", QSize(), QIcon.Normal, QIcon.On
        )
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/icons/icons/refresh_white_24dp.svg", QSize(), QIcon.Normal, QIcon.On
        )
        ...
        icon4 = QIcon()
        icon4.addFile(
            ":/icons/icons/content_copy_white_24dp.svg", QSize(), QIcon.Normal, QIcon.On
        )
        ...
        sizePolicy.setHeightForWidth(
            self.label_strength.sizePolicy().hasHeightForWidth()
        )
        ...
        self.layout_length.setObjectName("layout_length")
        ...
        self.spinbox_length.setStyleSheet(
            "QSpinBox {\n"
            "    border: 2px solid gray;\n"
            "    border-radius: 5px;\n"
        ...
        self.layout_characters.setObjectName("layout_characters")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_refresh.setShortcut(
            QCoreApplication.translate("MainWindow", "Ctrl+R", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.btn_copy.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_copy.setShortcut(
            QCoreApplication.translate("MainWindow", "Ctrl+C", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.label_strength.setText("")
        self.label_entropy.setText("")
        self.btn_lower.setText(QCoreApplication.translate("MainWindow", "a-z", None))
        self.btn_upper.setText(QCoreApplication.translate("MainWindow", "A-Z", None))
        self.btn_digits.setText(QCoreApplication.translate("MainWindow", "0-9", None))
        self.btn_special.setText(QCoreApplication.translate("MainWindow", "#$%", None))
